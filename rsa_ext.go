...
var (
	// ErrDataToLarge too large data err
	ErrDataToLarge = errors.New("message too long for RSA public key size")
	// ErrDataLen data length err
	ErrDataLen = errors.New("data length error")
	// ErrDataBroken data broken err
	ErrDataBroken = errors.New("data broken, first byte is not zero")
	// ErrKeyPairDismatch key pair mismatch err
	ErrKeyPairDismatch = errors.New("data is not encrypted by the private key")
	// ErrDecryption decryption err
	ErrDecryption = errors.New("decryption error")
	// ErrPublicKey public key err
	ErrPublicKey = errors.New("get public key error")
	// ErrPrivateKey private key err
